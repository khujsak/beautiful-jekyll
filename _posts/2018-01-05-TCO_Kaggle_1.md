...
subtitle: Geometric Voronoi Tesselation
use_math: true
...
In this blog, I'll give some hints about working with geometries files and extracting meaningful material feature based on these three-dimensional structures.  I'll mostly be following along with a recent publication by a colleague of mine, which you can find [here](https://journals.aps.org/prb/abstract/10.1103/PhysRevB.96.024104).
